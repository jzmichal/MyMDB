...
class MovieCell: UITableViewCell {
    ...
    func setupUserMovieNotes() {
        ...
        userMovieNotes.topAnchor.constraint(equalTo: contentView.topAnchor).isActive = true
    ...
    func setupMovieTitle() {
        movieTitle.leftAnchor.constraint(equalTo: moviePosterView.rightAnchor).isActive = true
        movieTitle.topAnchor.constraint(equalTo: contentView.topAnchor).isActive = true
        movieTitle.widthAnchor.constraint(lessThanOrEqualToConstant: 165).isActive = true
    ...
    func setupMovieYear() {
        ...
        //movieYear.rightAnchor.constraint(equalTo: contentView.rightAnchor).isActive = true
    ...
    func setupIMDBImageView(){
        ...
        iMDBImageView.widthAnchor.constraint(equalToConstant: 30).isActive = true
        iMDBImageView.heightAnchor.constraint(equalToConstant: 30).isActive = true
    }
    func setupRottenTomatoImageView() {
        ...
        rottenTomatoImageView.widthAnchor.constraint(equalToConstant: 30).isActive = true
        rottenTomatoImageView.heightAnchor.constraint(equalToConstant: 30).isActive = true
    }
    func setupMovieIMDBRating() {
        ...
        movieIMDBRating.widthAnchor.constraint(equalToConstant: 30).isActive = true
        movieIMDBRating.heightAnchor.constraint(equalToConstant: 30).isActive = true
    }
    func setupMovieRottenTomatoRating(){
        ...
        movieRottenTomatoRating.widthAnchor.constraint(equalToConstant: 30).isActive = true
        movieRottenTomatoRating.heightAnchor.constraint(equalToConstant: 30).isActive = true
    }
    ...
    func setupMyRatingButton() {
        ...
        //movieRatingButton.leftAnchor.constraint(equalToSystemSpacingAfter: moviePosterView.rightAnchor, multiplier: 1).isActive = true
        movieRatingButton.topAnchor.constraint(equalTo: rottenTomatoImageView.bottomAnchor).isActive = true
        //movieRatingButton.rightAnchor.constraint(equalToSystemSpacingAfter: movieCast.leftAnchor, multiplier: -2).isActive = true
        movieRatingButton.centerXAnchor.constraint(equalTo: rottenTomatoImageView.rightAnchor).isActive = true
        movieRatingButton.widthAnchor.constraint(equalToConstant: 70).isActive = true
        movieRatingButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor).isActive = true
    ...
    func setupAddToQueueButton() {
        ...
        //queueButton.leftAnchor.constraint(equalToSystemSpacingAfter: moviePosterView.rightAnchor, multiplier: 1).isActive = true
...
extension CustomMovieCell: UIPickerViewDelegate, UIPickerViewDataSource {
